...
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZhy{}\PYZhy{} file: base\PYZhy{}constrain.sql}
        ...
        \PY{k}{ALTER} \PY{k}{TABLE} \PY{n}{country} \PY{k}{ADD} \PY{k}{CONSTRAINT} \PY{n}{PK\PYZus{}COUNTRY} \PY{k}{PRIMARY} \PY{k}{KEY}\PY{p}{(}\PY{n}{country\PYZus{}id}\PY{p}{)}\PY{p}{;}
        \PY{k}{ALTER} \PY{k}{TABLE} \PY{n}{city} \PY{k}{ADD} \PY{k}{CONSTRAINT} \PY{n}{PK\PYZus{}CITY} \PY{k}{PRIMARY} \PY{k}{KEY}\PY{p}{(}\PY{n}{city\PYZus{}id}\PY{p}{)}\PY{p}{;}
        \PY{k}{ALTER} \PY{k}{TABLE} \PY{n}{address} \PY{k}{ADD} \PY{k}{CONSTRAINT} \PY{n}{PK\PYZus{}ADDRESS} \PY{k}{PRIMARY} \PY{k}{KEY}\PY{p}{(}\PY{n}{address\PYZus{}id}\PY{p}{)}\PY{p}{;}
        \PY{k}{ALTER} \PY{k}{TABLE} \PY{n}{store} \PY{k}{ADD} \PY{k}{CONSTRAINT} \PY{n}{PK\PYZus{}STORE} \PY{k}{PRIMARY} \PY{k}{KEY}\PY{p}{(}\PY{n}{store\PYZus{}id}\PY{p}{)}\PY{p}{;}
        \PY{k}{ALTER} \PY{k}{TABLE} \PY{n}{customer} \PY{k}{ADD} \PY{k}{CONSTRAINT} \PY{n}{PK\PYZus{}CUSTOMER} \PY{k}{PRIMARY} \PY{k}{KEY}\PY{p}{(}\PY{n}{customer\PYZus{}id}\PY{p}{)}\PY{p}{;}
        \PY{k}{ALTER} \PY{k}{TABLE} \PY{n}{payment} \PY{k}{ADD} \PY{k}{CONSTRAINT} \PY{n}{PK\PYZus{}PAYMENT} \PY{k}{PRIMARY} \PY{k}{KEY}\PY{p}{(}\PY{n}{payment\PYZus{}id}\PY{p}{)}\PY{p}{;}
        \PY{k}{ALTER} \PY{k}{TABLE} \PY{n}{rental} \PY{k}{ADD} \PY{k}{CONSTRAINT} \PY{n}{PK\PYZus{}RENTAL} \PY{k}{PRIMARY} \PY{k}{KEY}\PY{p}{(}\PY{n}{rental\PYZus{}id}\PY{p}{)}\PY{p}{;}
        
        
        \PY{k}{ALTER} \PY{k}{TABLE} \PY{n}{city} \PY{k}{ADD} \PY{k}{CONSTRAINT} \PY{n}{FK\PYZus{}CITY\PYZus{}COUNTRY} \PY{k}{FOREIGN} \PY{k}{KEY}\PY{p}{(}\PY{n}{country\PYZus{}id}\PY{p}{)} \PY{k}{REFERENCES}
        \PY{n}{country}\PY{p}{(}\PY{n}{country\PYZus{}id}\PY{p}{)}\PY{p}{;}
        
        \PY{k}{ALTER} \PY{k}{TABLE} \PY{n}{address} \PY{k}{ADD} \PY{k}{CONSTRAINT} \PY{n}{FK\PYZus{}ADDRESS\PYZus{}CITY} \PY{k}{FOREIGN} \PY{k}{KEY}\PY{p}{(}\PY{n}{city\PYZus{}id}\PY{p}{)} \PY{k}{REFERENCES}
        \PY{n}{city}\PY{p}{(}\PY{n}{city\PYZus{}id}\PY{p}{)}\PY{p}{;}
        
        \PY{k}{ALTER} \PY{k}{TABLE} \PY{n}{staff} \PY{k}{ADD} \PY{k}{CONSTRAINT} \PY{n}{PK\PYZus{}STAFF} \PY{k}{PRIMARY} \PY{k}{KEY}\PY{p}{(}\PY{n}{staff\PYZus{}id}\PY{p}{)}\PY{p}{;}
        
        \PY{k}{ALTER} \PY{k}{TABLE} \PY{n}{store} \PY{k}{ADD} \PY{k}{CONSTRAINT} \PY{n}{FK\PYZus{}STORE\PYZus{}MANAGER} \PY{k}{FOREIGN} \PY{k}{KEY}\PY{p}{(}\PY{n}{manager\PYZus{}staff\PYZus{}id}\PY{p}{)}
        \PY{k}{REFERENCES} \PY{n}{staff}\PY{p}{(}\PY{n}{staff\PYZus{}id}\PY{p}{)}\PY{p}{;}
        \PY{k}{ALTER} \PY{k}{TABLE} \PY{n}{store} \PY{k}{ADD} \PY{k}{CONSTRAINT} \PY{n}{FK\PYZus{}STORE\PYZus{}ADDRESS} \PY{k}{FOREIGN} \PY{k}{KEY}\PY{p}{(}\PY{n}{address\PYZus{}id}\PY{p}{)} \PY{k}{REFERENCES}
        \PY{n}{address}\PY{p}{(}\PY{n}{address\PYZus{}id}\PY{p}{)}\PY{p}{;}
        
        \PY{k}{ALTER} \PY{k}{TABLE} \PY{n}{staff} \PY{k}{ADD} \PY{k}{CONSTRAINT} \PY{n}{FK\PYZus{}STAFF\PYZus{}ADDRESS} \PY{k}{FOREIGN} \PY{k}{KEY}\PY{p}{(}\PY{n}{address\PYZus{}id}\PY{p}{)} \PY{k}{REFERENCES}
        \PY{n}{address}\PY{p}{(}\PY{n}{address\PYZus{}id}\PY{p}{)}\PY{p}{;}
        \PY{k}{ALTER} \PY{k}{TABLE} \PY{n}{staff} \PY{k}{ADD} \PY{k}{CONSTRAINT} \PY{n}{FK\PYZus{}STAFF\PYZus{}STORE} \PY{k}{FOREIGN} \PY{k}{KEY}\PY{p}{(}\PY{n}{store\PYZus{}id}\PY{p}{)} \PY{k}{REFERENCES}
        \PY{n}{store}\PY{p}{(}\PY{n}{store\PYZus{}id}\PY{p}{)}\PY{p}{;}
        
        \PY{k}{ALTER} \PY{k}{TABLE} \PY{n}{customer} \PY{k}{ADD} \PY{k}{CONSTRAINT} \PY{n}{FK\PYZus{}CUSTOMER\PYZus{}STORE} \PY{k}{FOREIGN} \PY{k}{KEY}\PY{p}{(}\PY{n}{store\PYZus{}id}\PY{p}{)} \PY{k}{REFERENCES}
        \PY{n}{store}\PY{p}{(}\PY{n}{store\PYZus{}id}\PY{p}{)}\PY{p}{;}
        \PY{k}{ALTER} \PY{k}{TABLE} \PY{n}{customer} \PY{k}{ADD} \PY{k}{CONSTRAINT} \PY{n}{FK\PYZus{}CUSTOMER\PYZus{}ADDRESS} \PY{k}{FOREIGN} \PY{k}{KEY}\PY{p}{(}\PY{n}{address\PYZus{}id}\PY{p}{)}
        \PY{k}{REFERENCES} \PY{n}{address}\PY{p}{(}\PY{n}{address\PYZus{}id}\PY{p}{)}\PY{p}{;}
        
        \PY{k}{ALTER} \PY{k}{TABLE} \PY{n}{inventory} \PY{k}{ADD} \PY{k}{CONSTRAINT} \PY{n}{PK\PYZus{}INVENTORY} \PY{k}{PRIMARY} \PY{k}{KEY}\PY{p}{(}\PY{n}{inventory\PYZus{}id}\PY{p}{)}\PY{p}{;}
        \PY{k}{ALTER} \PY{k}{TABLE} \PY{n}{inventory} \PY{k}{ADD} \PY{k}{CONSTRAINT} \PY{n}{FK\PYZus{}INVENTORY\PYZus{}STORE} \PY{k}{FOREIGN} \PY{k}{KEY}\PY{p}{(}\PY{n}{store\PYZus{}id}\PY{p}{)} \PY{k}{REFERENCES}
        \PY{n}{store}\PY{p}{(}\PY{n}{store\PYZus{}id}\PY{p}{)}\PY{p}{;}
        \PY{c+c1}{\PYZhy{}\PYZhy{}ALTER TABLE inventory ADD CONSTRAINT FK\PYZus{}INVENTORY\PYZus{}RENTAL FOREIGN KEY(film\PYZus{}id)}
        \PY{k}{REFERENCES} \PY{n}{rental}\PY{p}{(}\PY{n}{rental\PYZus{}id}\PY{p}{)}\PY{p}{;}
        
        \PY{k}{ALTER} \PY{k}{TABLE} \PY{n}{payment} \PY{k}{ADD} \PY{k}{CONSTRAINT} \PY{n}{FK\PYZus{}PAYMENT\PYZus{}CUSTOMER} \PY{k}{FOREIGN} \PY{k}{KEY}\PY{p}{(}\PY{n}{customer\PYZus{}id}\PY{p}{)}
        \PY{k}{REFERENCES} \PY{n}{customer}\PY{p}{(}\PY{n}{customer\PYZus{}id}\PY{p}{)}\PY{p}{;}
        \PY{k}{ALTER} \PY{k}{TABLE} \PY{n}{payment} \PY{k}{ADD} \PY{k}{CONSTRAINT} \PY{n}{FK\PYZus{}PAYMENT\PYZus{}STAFF} \PY{k}{FOREIGN} \PY{k}{KEY}\PY{p}{(}\PY{n}{staff\PYZus{}id}\PY{p}{)} \PY{k}{REFERENCES}
        \PY{n}{staff}\PY{p}{(}\PY{n}{staff\PYZus{}id}\PY{p}{)}\PY{p}{;}
        \PY{k}{ALTER} \PY{k}{TABLE} \PY{n}{payment} \PY{k}{ADD} \PY{k}{CONSTRAINT} \PY{n}{FK\PYZus{}PAYMENT\PYZus{}RENTAL} \PY{k}{FOREIGN} \PY{k}{KEY}\PY{p}{(}\PY{n}{rental\PYZus{}id}\PY{p}{)} \PY{k}{REFERENCES}
        \PY{n}{rental}\PY{p}{(}\PY{n}{rental\PYZus{}id}\PY{p}{)}\PY{p}{;}
        
        \PY{k}{ALTER} \PY{k}{TABLE} \PY{n}{rental} \PY{k}{ADD} \PY{k}{CONSTRAINT} \PY{n}{FK\PYZus{}RENTAL\PYZus{}INVENTORY} \PY{k}{FOREIGN} \PY{k}{KEY}\PY{p}{(}\PY{n}{inventory\PYZus{}id}\PY{p}{)}
        \PY{k}{REFERENCES} \PY{n}{inventory}\PY{p}{(}\PY{n}{inventory\PYZus{}id}\PY{p}{)}\PY{p}{;}
        \PY{k}{ALTER} \PY{k}{TABLE} \PY{n}{rental} \PY{k}{ADD} \PY{k}{CONSTRAINT} \PY{n}{FK\PYZus{}RENTAL\PYZus{}CUSTOMER} \PY{k}{FOREIGN} \PY{k}{KEY}\PY{p}{(}\PY{n}{customer\PYZus{}id}\PY{p}{)} \PY{k}{REFERENCES}
        \PY{n}{customer}\PY{p}{(}\PY{n}{customer\PYZus{}id}\PY{p}{)}\PY{p}{;}
        \PY{k}{ALTER} \PY{k}{TABLE} \PY{n}{rental} \PY{k}{ADD} \PY{k}{CONSTRAINT} \PY{n}{FK\PYZus{}RENTAL\PYZus{}STAFF} \PY{k}{FOREIGN} \PY{k}{KEY}\PY{p}{(}\PY{n}{staff\PYZus{}id}\PY{p}{)} \PY{k}{REFERENCES}
        \PY{n}{staff}\PY{p}{(}\PY{n}{staff\PYZus{}id}\PY{p}{)}\PY{p}{;}
\end{Verbatim}
...
\subsubsection{Exercice 3. Tester les requêtes suivantes qui pourront
peut-être vous servir à un moment dans le
TP.}\label{exercice-3.-tester-les-requuxeates-suivantes-qui-pourront-peut-uxeatre-vous-servir-uxe0-un-moment-dans-le-tp.}}

   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}1}]:} \PY{k}{set} \PY{n}{datestyle} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{european}\PY{l+s+s1}{\PYZsq{}}
...
\end{Verbatim}
   ...
   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}2}]:} \PY{k}{SELECT} \PY{n+nb}{date} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{2001\PYZhy{}10\PYZhy{}01}\PY{l+s+s1}{\PYZsq{}} \PY{o}{\PYZhy{}} \PY{n+nb}{date} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{2001\PYZhy{}09\PYZhy{}28}\PY{l+s+s1}{\PYZsq{}}\PY{p}{;}
...
\section{Requêtes SQL}\label{requuxeates-sql}}

Ecrire des requêtes SQL pour répondre aux questions suivantes. Par
défaut on ne demande jamais de trier les résultats ou de supprimer les
doublons.
...
euros.}\label{exercice-4.-identifiant-de-tous-les-clients-ayant-un-montant-de-paiement-compris-entre-1-et-2-euros.}}
   ...
   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}3}]:} \PY{k}{SELECT} \PY{k}{DISTINCT} \PY{n}{c}\PY{l+m+mf}{.}\PY{n}{first\PYZus{}name}\PY{p}{,} \PY{n}{c}\PY{l+m+mf}{.}\PY{n}{last\PYZus{}name}\PY{p}{,} \PY{n}{p}\PY{l+m+mf}{.}\PY{n}{amount}
...
\subsubsection{Exercice 5. Locations (tous les attributs) qui ont été
retournées moins de 24h après leur
emprunt}\label{exercice-5.-locations-tous-les-attributs-qui-ont-uxe9tuxe9-retournuxe9es-moins-de-24h-apruxe8s-leur-emprunt}}

   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}4}]:} \PY{k}{SELECT} \PY{k}{DISTINCT} \PY{o}{*}
...
\subsubsection{Exercice 6. Locations (tous les attributs) qui ont été
...
(exclus)}\label{exercice-6.-locations-tous-les-attributs-qui-ont-uxe9tuxe9-faites-entre-23h-et-minuit-exclus}}
   ...
   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}5}]:} \PY{k}{SELECT} \PY{o}{*}
        \PY{k}{FROM} \PY{n}{rental} \PY{n}{r}
...
\subsubsection{Exercice 7. Prénom et nom des clients dont le code postal
commence par
47}\label{exercice-7.-pruxe9nom-et-nom-des-clients-dont-le-code-postal-commence-par-47}}

   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}6}]:} \PY{k}{SELECT} \PY{n}{c}\PY{l+m+mf}{.}\PY{n}{first\PYZus{}name}\PY{p}{,} \PY{n}{c}\PY{l+m+mf}{.}\PY{n}{last\PYZus{}name}
...
France}\label{exercice-8.-tous-les-identifiants-distincts-dadresse-en-france}}
   ...
   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}23}]:} \PY{k}{SELECT} \PY{k}{DISTINCT} \PY{n}{a}\PY{l+m+mf}{.}\PY{n}{address\PYZus{}id}
...
n'ont jamais été
loués}\label{exercice-9.-identifiant-des-films-de-linventaire-qui-nont-jamais-uxe9tuxe9-louuxe9s}}

   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}8}]:} \PY{k}{SELECT} \PY{n}{i}\PY{l+m+mf}{.}\PY{n}{inventory\PYZus{}id}\PY{p}{,} \PY{n}{i}\PY{l+m+mf}{.}\PY{n}{film\PYZus{}id}
...
--------------  ---------
   ...
   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}9}]:} \PY{k}{SELECT} \PY{k}{DISTINCT} \PY{n}{r}\PY{l+m+mf}{.}\PY{n}{inventory\PYZus{}id}
        \PY{k}{FROM} \PY{n}{rental} \PY{n}{r}
...
qu'ils ont été
loués}\label{exercice-10.-identifiant-des-films-et-nombre-de-fois-quils-ont-uxe9tuxe9-louuxe9s}}

   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}10}]:} \PY{k}{SELECT} \PY{n}{i}\PY{l+m+mf}{.}\PY{n}{film\PYZus{}id}\PY{p}{,} \PY{n}{COUNT}\PY{p}{(}\PY{n}{r}\PY{l+m+mf}{.}\PY{n}{rental\PYZus{}id}\PY{p}{)}
...
\subsubsection{Exercice 11. Prénom, nom et nombre de locations par
client}\label{exercice-11.-pruxe9nom-nom-et-nombre-de-locations-par-client}}

   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}11}]:} \PY{k}{SELECT} \PY{n}{c}\PY{l+m+mf}{.}\PY{n}{first\PYZus{}name}\PY{p}{,} \PY{n}{c}\PY{l+m+mf}{.}\PY{n}{last\PYZus{}name}\PY{p}{,} \PY{n}{COUNT}\PY{p}{(}\PY{k}{DISTINCT} \PY{n}{r}\PY{l+m+mf}{.}\PY{n}{rental\PYZus{}id}\PY{p}{)}
...
\subsubsection{Exercice 12. Nombre de films distincts loués par une
...
Allemagne}\label{exercice-12.-nombre-de-films-distincts-louuxe9s-par-une-personne-habitant-en-allemagne}}
   ...
   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}12}]:} \PY{k}{SELECT} \PY{n}{COUNT}\PY{p}{(}\PY{k}{DISTINCT} \PY{n}{i}\PY{l+m+mf}{.}\PY{n}{film\PYZus{}id}\PY{p}{)}
...
locations}\label{exercice-13.-identifiant-de-magasin-et-nombre-de-locations}}
   ...
   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}13}]:} \PY{k}{SELECT} \PY{n}{s}\PY{l+m+mf}{.}\PY{n}{store\PYZus{}id}\PY{p}{,} \PY{n}{COUNT}\PY{p}{(}\PY{k}{DISTINCT} \PY{n}{r}\PY{l+m+mf}{.}\PY{n}{rental\PYZus{}id}\PY{p}{)}
...
\subsubsection{Exercice 14. Prénom, nom, montant moyen et montant total
dépensé par
client}\label{exercice-14.-pruxe9nom-nom-montant-moyen-et-montant-total-duxe9pensuxe9-par-client}}

   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}14}]:} \PY{k}{SELECT} \PY{n}{c}\PY{l+m+mf}{.}\PY{n}{first\PYZus{}name}\PY{p}{,} \PY{n}{c}\PY{l+m+mf}{.}\PY{n}{last\PYZus{}name}\PY{p}{,} \PY{n}{AVG}\PY{p}{(}\PY{n}{p}\PY{l+m+mf}{.}\PY{n}{amount}\PY{p}{)}\PY{p}{,} \PY{n}{SUM}\PY{p}{(}\PY{n}{p}\PY{l+m+mf}{.}\PY{n}{amount}\PY{p}{)}
         \PY{k}{FROM} \PY{n}{customer} \PY{n}{c}\PY{p}{,} \PY{n}{payment} \PY{n}{p}
...
\subsubsection{Exercice 15. Numéro de client, jour et nombre de location
pour ce jour et ce
client}\label{exercice-15.-numuxe9ro-de-client-jour-et-nombre-de-location-pour-ce-jour-et-ce-client}}

   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}15}]:} \PY{k}{SELECT} \PY{n}{r1}\PY{l+m+mf}{.}\PY{n}{customer\PYZus{}id}\PY{p}{,} \PY{n}{r1}\PY{l+m+mf}{.}\PY{n}{rdate}\PY{p}{,} \PY{n}{r1}\PY{l+m+mf}{.}\PY{n}{nbLocationClient}\PY{p}{,} \PY{n}{r2}\PY{l+m+mf}{.}\PY{n}{nbLocationJour} \PY{k}{FROM}
         \PY{p}{(}
...
\subsubsection{Exercice 16. Prénom et nom des clients ayant effectué
...
locations}\label{exercice-16.-pruxe9nom-et-nom-des-clients-ayant-effectuuxe9-strictement-moins-de-15-locations}}
   ...
   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}16}]:} \PY{k}{SELECT} \PY{n}{c}\PY{l+m+mf}{.}\PY{n}{first\PYZus{}name}\PY{p}{,} \PY{n}{c}\PY{l+m+mf}{.}\PY{n}{last\PYZus{}name}\PY{p}{,} \PY{n}{COUNT}\PY{p}{(}\PY{k}{DISTINCT} \PY{n}{r}\PY{l+m+mf}{.}\PY{n}{rental\PYZus{}id}\PY{p}{)} \PY{k}{as} \PY{n}{nbLocations}
         \PY{k}{FROM} \PY{n}{customer} \PY{n}{c}\PY{p}{,} \PY{n}{rental} \PY{n}{r}
         \PY{k}{WHERE} \PY{n}{c}\PY{l+m+mf}{.}\PY{n}{customer\PYZus{}id} \PY{o}{=} \PY{n}{r}\PY{l+m+mf}{.}\PY{n}{customer\PYZus{}id}
         \PY{k}{GROUP} \PY{k}{BY} \PY{n}{c}\PY{l+m+mf}{.}\PY{n}{first\PYZus{}name}\PY{p}{,} \PY{n}{c}\PY{l+m+mf}{.}\PY{n}{last\PYZus{}name}
...
\subsubsection{Exercice 17. Nombre de clients qui ont effectué une
...
OR)}\label{exercice-17.-nombre-de-clients-qui-ont-effectuuxe9-une-location-le-30-juillet-2005-ou-habitent-au-code-postal-35200-ne-pas-utiliser-or}}
   ...
   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}17}]:} \PY{p}{(}
...
quelconque}\label{exercice-18.-identifiant-des-clients-ayant-effectuuxe9-une-location-le-11-dun-mois-quelconque-mais-pas-le-10-dun-mois-quelconque}}
   ...
   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}18}]:} \PY{k}{SELECT} \PY{n}{r1}\PY{l+m+mf}{.}\PY{n}{customer\PYZus{}id}\PY{p}{,} \PY{n}{r2}\PY{l+m+mf}{.}\PY{n}{rdate} \PY{k}{FROM}
         \PY{p}{(}
...
journée}\label{exercice-19.-nombre-maximum-de-location-en-une-journuxe9e}}

   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}19}]:} \PY{k}{SELECT} \PY{n}{MAX}\PY{p}{(}\PY{n}{r1}\PY{l+m+mf}{.}\PY{n}{nbLoc}\PY{p}{)} \PY{k}{FROM}
         \PY{p}{(}
...
\subsubsection{Exercice 20. Numéro du client ayant effectué le plus de
locations en une journée. Proposer au moins 3 solutions
...
\paragraph{Solution 1:}\label{solution-1}}
   ...
   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}20}]:} \PY{k}{SELECT} \PY{n}{r1}\PY{l+m+mf}{.}\PY{n}{customer\PYZus{}id}\PY{p}{,} \PY{n}{MAX}\PY{p}{(}\PY{n}{r1}\PY{l+m+mf}{.}\PY{n}{nbLoc}\PY{p}{)} \PY{k}{as} \PY{n+nb}{record} \PY{k}{FROM}
         \PY{p}{(}
             \PY{k}{SELECT} \PY{n}{c}\PY{l+m+mf}{.}\PY{n}{customer\PYZus{}id}\PY{p}{,} \PY{n}{r}\PY{l+m+mf}{.}\PY{n}{rental\PYZus{}date}\PY{o}{::}\PY{n+nb}{timestamp}\PY{o}{::}\PY{n+nb}{date} \PY{k}{as} \PY{n}{rdate}\PY{p}{,} \PY{n}{COUNT}\PY{p}{(}\PY{k}{DISTINCT}
...
\paragraph{Solution 2:}\label{solution-2}}
   ...
   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}21}]:} \PY{k}{WITH} \PY{n}{r1} \PY{k}{as} \PY{p}{(}
             \PY{k}{SELECT} \PY{n}{c}\PY{l+m+mf}{.}\PY{n}{customer\PYZus{}id}\PY{p}{,} \PY{n}{r}\PY{l+m+mf}{.}\PY{n}{rental\PYZus{}date}\PY{o}{::}\PY{n+nb}{timestamp}\PY{o}{::}\PY{n+nb}{date} \PY{k}{as} \PY{n}{rdate}\PY{p}{,} \PY{n}{COUNT}\PY{p}{(}\PY{k}{DISTINCT}
         \PY{n}{r}\PY{l+m+mf}{.}\PY{n}{rental\PYZus{}id}\PY{p}{)} \PY{k}{as} \PY{n}{nbLoc}
             \PY{k}{FROM} \PY{n}{rental} \PY{n}{r}\PY{p}{,} \PY{n}{customer} \PY{n}{c}
             \PY{k}{WHERE} \PY{n}{r}\PY{l+m+mf}{.}\PY{n}{customer\PYZus{}id} \PY{o}{=} \PY{n}{c}\PY{l+m+mf}{.}\PY{n}{customer\PYZus{}id}
